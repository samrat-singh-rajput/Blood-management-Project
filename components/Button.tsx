...
export const Button: React.FC<ButtonProps> = ({ 
  ...
  const variants = {
    primary: "bg-blood-600 text-white hover:bg-blood-700 shadow-lg hover:shadow-blood-500/30",
    secondary: "bg-gray-800 text-white hover:bg-gray-900",
    outline: "border-2 border-blood-600 text-blood-600 hover:bg-blood-50",
